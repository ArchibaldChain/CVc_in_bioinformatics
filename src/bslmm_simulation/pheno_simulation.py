...
def phenotype_generator(bimbam_dir,
    ...
    print("The sigma_g^2 is {:.5}, and sigma_e^2 is {:.5}".format(
        sigma_g2, sigma_e2))
...
def train_test_split(bimbam_data, pheno):
    ...
    return data_spliter(bimbam_data, pheno, train_idx.tolist(),
                        test_idx.tolist())
...
if __name__ == "__main__":
    ...
    (bimbam_train,
     pheno_tr), (bimbam_test, pheno_te) = train_test_split(bimbam_data, pheno)
    print(bimbam_train.shape, bimbam_test.shape, pheno_tr.shape,
          pheno_te.shape)
